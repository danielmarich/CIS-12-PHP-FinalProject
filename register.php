...
if ($errors == 0) {
     ...
     if ($QueryResult === FALSE) {
          ...
          $_SESSION['cbmember_id'] = mysql_insert_id($DBConnect);
     }
     setcookie("cbmember_id", $_SESSION['cbmember_id']);
...
if ($errors == 0) {
     ...
     $Body .= "Your new Intern ID is <strong>" .
          $_SESSION['cbmember_id'] . "</strong>.</p>\n";
}
if ($errors == 0) {
     $Body .= "<p><a href='cbmemberpage.php?" .
               SID . "'>Click to go to your Comic Book Manager member page.</a></p>\n";
}
...
<head>
<title>Comic Book Manager Registration</title>
<meta http-equiv="content-type" content="text/html; charset=iso-8859-1" />
</head>
<body>
<h1>Comic Book Manager</h1>
<h2>Comic Book Manager Registration</h2>
<?php
echo $Body;
?>
</body>
